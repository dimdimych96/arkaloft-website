      ...
      {isOpen && (
        ...
        >
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            {/* Story title and CTA */}
            <div className="absolute bottom-0 left-0 right-0 px-4 pb-8 bg-gradient-to-t from-black/80 via-black/40 to-transparent pt-20 pointer-events-none">
              <motion.div
                key={currentIndex}
              ...
              >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-primary text-white font-black text-sm sm:text-base rounded-2xl hover:bg-primary-hover transition-all active:scale-95 shadow-lg pointer-events-auto"
                >
